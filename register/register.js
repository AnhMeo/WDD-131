...
function totalFees() {
    ...
    return feeElements.reduce((total, feeElement) => {
        // Convert the value to a number and add it to total
        // If the value is empty or not a number, add 0
